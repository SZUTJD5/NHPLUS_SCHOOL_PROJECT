        ...
        public class PatientDao extends DaoImp<Patient> {
            ...
            public void deleteOldLockedPatients() {
                try {
                    ...
                    // SQL query to select patients older than 10 years and locked
                    ...
                    // Iterate over all matching patients
                    while (resultSet.next()) {
                        long tempPid = resultSet.getLong("pid");

                        // Update treatments to set pid to 0 where pid equals tempPid
